          ...
          <div className="container relative z-10">
            <div className="max-w-5xl mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-12">
                <Button 
                  onClick={() => window.location.href = "https://wa.me/919148898988?text=I'm%20interested%20in%20the%20KN0X%20Elite%20Program"}
                ...
                <div className="text-center">
                  <div className="text-4xl font-bold font-knockout text-white">₹2999</div>
        ...
        <section className="py-24 bg-gradient-to-br from-knox-black to-knox-gray text-white">
          <div className="container">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-12">
                <Button 
                  onClick={() => window.location.href = "https://wa.me/919148898988?text=I%20want%20to%20join%20the%20KN0X%20Elite%20Program%20today"}
                  className="btn-primary text-xl py-8 px-12 text-white bg-knox-red hover:bg-knox-darkred transform hover:scale-105 transition-all duration-300 shadow-2xl"
                  size="lg"
                >
                  Join Elite Program Now - ₹2999
                </Button>
              </div>
