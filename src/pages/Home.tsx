  ...
  return (
    <>
      <SEOHead
        ...
        canonical="https://kn0x.fit/"
        ogImage="https://kn0x.fit/hero-image.webp"
        breadcrumb={[
          { name: "Home", url: "https://kn0x.fit/" }
        ]}
      />
      <StructuredData
        type="organization"
        data={{
          image: [
            "https://kn0x.fit/hero-image.webp",
            "https://kn0x.fit/diet-plan.jpeg",
            "https://kn0x.fit/workout-plan.avif"
          ]
        }}
      />
      <StructuredData
