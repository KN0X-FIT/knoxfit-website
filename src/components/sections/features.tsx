...
const features: Feature[] = [
  ...
  },
  {
    ...
    description: 'Regular sessions with Expert Trainers who provide guidance, motivation, and accountability.',
    icon: (
      <svg className="h-10 w-10 text-knox-red" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="container">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-gray-600 text-lg">
            ...
            to help you achieve your fitness goals with sustainable diet plans and custom workout routines.
          </p>
        </div>
